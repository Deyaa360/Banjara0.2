        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="flex space-x-6">
              {navigation.social.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className="text-primary-dark/70 hover:text-primary"
                >
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold text-primary-dark">Navigation</h3>
                <ul role="list" className="mt-4 space-y-4">
                  {navigation.main.map((item) => (
                    <li key={item.name}>
                      <Link
                        href={item.href}
                        className="text-sm text-primary-dark/70 hover:text-primary"
                      >
                        {item.name}
                      </Link>
                    </li>
              ...
              <div className="mt-12 md:mt-0">
                <h3 className="text-sm font-semibold text-primary-dark">Contact</h3>
                <ul role="list" className="mt-4 space-y-4">
                  <li>
                    <p className="text-sm text-primary-dark/70">
                      123 Heritage Street
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold text-primary-dark">Hours</h3>
                <ul role="list" className="mt-4 space-y-4">
                  <li>
                    <p className="text-sm text-primary-dark/70">
