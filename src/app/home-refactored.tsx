...
import { MenuPreviewSection } from "@/components/sections/menu";
import { GallerySection } from "@/components/sections/gallery";
import { ContactSection } from "@/components/sections/contact";
import { AnimatedSection, ResponsiveContainer, LazySection } from "@/components/common";
...
export default function HomeRefactored() {
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* Menu Preview Section - Lazy loaded */}
      <LazySection id="menu-section">
        <MenuPreviewSection 
          categories={[
          {
            id: "starters",
            ...
            items: [
              {
                id: "butter-chicken",
                name: "Butter Chicken",
                description: "Tender chicken in a rich tomato gravy, finished with cream and butter",
                price: "$18.99",
                isSignature: true
              },
              {
